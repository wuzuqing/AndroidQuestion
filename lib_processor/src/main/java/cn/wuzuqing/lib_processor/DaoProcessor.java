...
public class DaoProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        Set<? extends Element> elementSet = roundEnvironment.getElementsAnnotatedWith(Entity.class);
    ...
    private void generateFile(Map<String, List<VariableElement>> maps, Map<String, List<ExecutableElement>> constructorMaps, String packageName) {
        ...
        for (String key : maps.keySet()) {
            try {
                ...
                String className = Utils.getName(typeElement);
                ...
                sb.append("import " + key + ";\n").
                        append("import cn.wuzuqing.lib_api.AbstractDao;\n").
                        append("import cn.wuzuqing.lib_api.Database;\n").
    ...
    private List<FieldProperty> refreshClassFile(String key, List<VariableElement> variableElements, TypeElement classElement) {
        ...
        if (Utils.isEmpty(entity.nameInDb())) {
            sb.append("@Entity()\n");
        } else {
            sb.append("@Entity( nameInDb = \"" + entity.nameInDb() + "\")\n");
        }

        String className = Utils.getName(classElement);
        ...
        for (VariableElement variableElement : variableElements) {
            ...
            if (annotation != null) {
                ...
                if (index != null) {
                    fieldProperty.appendAnnotation(sb, "Index", "name", index.name(), Utils.isEmpty(index.name()));
                }
            }
        ...
        StringBuilder toStr = new StringBuilder("\t@Override\n\tpublic String toString() {\n\t\treturn \"").append(className).append("{\" +\n");
    ...
    private void createDaoSession(List<String> classNames, String newPackage, boolean notNeedRefresh) {
        ...
        sb.append("import cn.wuzuqing.lib_api.Database;\n");
        sb.append("import cn.wuzuqing.lib_api.LifeCallBack;\n\n\n");
