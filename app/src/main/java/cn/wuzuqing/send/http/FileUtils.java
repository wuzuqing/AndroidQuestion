...
/**
 * @Author:         吴祖清
 * @CreateDate:     2018/10/30 10:15
 * @Description:
 * @UpdateUser:     吴祖清
 * @UpdateDate:     2018/10/30 10:15
 * @UpdateRemark:   更新说明
 * @Version:        1.0
 */
public final class FileUtils {
    ...
    public static String getAppRoot() {
        return Environment.getExternalStorageDirectory() + "/lotterylive";
    }

    public static String getDir(String dir) {
        String path = String.format("%s/%s", getAppRoot(), dir);
