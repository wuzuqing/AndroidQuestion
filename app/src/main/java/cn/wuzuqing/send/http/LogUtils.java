...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MyApplication.getApp()
                    .getPackageManager()
                    .getPackageInfo(MyApplication.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private String mGlobalTag         = "LogUtils";  // The global tag of log.
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApplication.getApp().getExternalCacheDir() != null) {
                mDefaultDir = MyApplication.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                mDefaultDir = MyApplication.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
