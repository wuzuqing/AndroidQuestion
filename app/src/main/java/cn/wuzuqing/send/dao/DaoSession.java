...
public class DaoSession  implements LifeCallBack {
	...
	public QuestionTagBeanDao getQuestionTagBeanDao() {return questionTagBeanDao;}

	public AnswerBeanDao getAnswerBeanDao() {return answerBeanDao;}

	public QuestionBeanDao getQuestionBeanDao() {return questionBeanDao;}
